...
import com.example.rashidsaleem.practice.common.media.CameraHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCaptureClick(View view) {
        if (isRecording) {
            ...
            new MediaPreparTask().execute(null, null, null);
        }
    }
...
//            e.printStackTrace();
     ...
     * operation.
     */
    class MediaPreparTask extends AsyncTask<Void, Void, Boolean> {
